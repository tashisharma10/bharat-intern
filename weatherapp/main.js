...
function getWeather(city) {
  const urlCurrent = `http://api.weatherapi.com/v1/current.json?key=3287c63dd27747338fd152051242606&q=${city}`;
...
function getWeatherForecast(city){
  const urlForecast =`http://api.weatherapi.com/v1/forecast.json?key=3287c63dd27747338fd152051242606&q=${city}&days=7`;
